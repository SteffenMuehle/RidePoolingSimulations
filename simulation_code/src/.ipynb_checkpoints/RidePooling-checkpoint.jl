...
struct Subspace
    ...
    category::Symbol            # either :area_to_node, :area_to_edge, :edge, :node
    content::Tuple              # polygon (area-uniform requests) or point(s) (node-uniform requests)
end
...
include("functions/feasibility_criteria.jl") #heuristics used by dispatcher logic.
